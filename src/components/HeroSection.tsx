        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="animate-fade-up">
            <h1 className="text-5xl md:text-7xl font-bold text-foreground mb-6 leading-tight">
              Hi, I'm{" "}
              <span className="text-primary animate-pulse-glow">Abhijeet</span> – 
              <br />
              <span className="text-shimmer">AI & Coding Enthusiast</span>
            </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12 animate-fade-up stagger-2">
            ...
            <a
              href="#projects"
              className="px-8 py-6 text-lg rounded-xl font-semibold button-gradient hover-lift hover-glow animate-pulse-glow inline-flex items-center justify-center"
            >
              View My Work
            </a>
            ...
            <a
              ...
              download="AbhijeetSingh_Resume.pdf"
              className="text-lg px-8 py-6 rounded-xl font-semibold border-primary text-primary hover:bg-primary hover:text-primary-foreground hover-lift hover-scale border inline-flex items-center justify-center"
            >
              Download Resume
            </a>
          </div>
