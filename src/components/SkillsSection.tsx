...
const SkillsSection = () => {
  ...
  const skillCategories = [
    ...
    {
      title: "DevOps & Tools",
      skills: ["Docker", "Kubernetes", "AWS", "Git", "GitHub Actions", "Linux", "Terraform"]
    },
    {
      title: "Specializations",
      skills: ["Machine Learning", "Deep Learning", "Computer Vision", "NLP", "Data Analysis", "Algorithm Design"]
    }
  ];
